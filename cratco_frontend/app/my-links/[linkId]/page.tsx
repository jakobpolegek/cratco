    ...
    if (!link) {
        return (
            <div className="text-center text-xl mt-10 text-gray-100">
                ...
                <p>The link you are looking for does not exist or you do not have permission to view it.</p>
                <Link href="/my-links" className="btn btn-secondary mt-4">Go back!</Link>
            </div>
        );
    }
